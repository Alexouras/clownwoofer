...
namespace KeyAuth
{
    ...
    public partial class Main : Form
    {
        ...
        private void guna2Button4_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Crown Woofer: Unlinked successfully");
        }
        ...
        private void guna2Button3_Click_1(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Spoofed successfully");
        }
        ...
        private void guna2Button17_Click_1(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Cache has been cleared");
        }
        ...
        private void guna2Button18_Click(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Citizen has been cleared");
        }
        ...
        private void guna2Button19_Click(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Reshade has been cleared");
        }
        ...
        private void guna2Button22_Click(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Temp has been cleared");
        }
        ...
        private void guna2Button20_Click(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Dns cache has been cleared");
        }
        ...
        private void guna2Button21_Click(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Recycle bin has been cleared");
        }
        ...
        private void guna2Button16_Click_2(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Fivem Cache has been cleared");
        }
        ...
        private void guna2Button18_Click_1(object sender, EventArgs e)
        {
            ...
            process.WaitForExit();
            File.Delete(tempFilename);
            MessageBox.Show("Crown Woofer: Windows for fivem has been optimized");
        }
        ...
        private void guna2Button20_Click_2(object sender, EventArgs e)
        {
            Font NormalFont = new Font("Arial", 12);
            Font BoldFont = new Font("Arial", 12, FontStyle.Bold);
            if (guna2Button20.Text == "SHOW")
            {

                guna2Button20.Text = "HIDE";
                label27.Text = Login.KeyAuthApp.user_data.ip;
                label27.Font = NormalFont;
            }
            else
            {
                label27.Text = "HIDDEN";
                guna2Button20.Text = "SHOW";
                label27.Font = BoldFont;
            }
